...
<div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
    ...
    <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
        ...
        <div class="flex items-center justify-center px-3 py-2 bg-gray-200 dark:bg-gray-800">
            <a href={"/users/#{@current_user.id}/edit"} class=" tex-center px-2 py-1 text-xs font-semibold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">edit</a>
          </div>
    </div>
</div>
    """
