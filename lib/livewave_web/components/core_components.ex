defmodule LivewaveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivewaveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivewaveWeb.Gettext, "errors", msg, opts)
    end
  end
